...
<html>
     <head>
	  ...
	  <meta charset="UTF-8">
    <title>  E-przedszkolanka - opłaty</title>
			...
			<div class="row">
                <div class="col-sm-12 col-md-6 login">
					  ...
					  <form action="wyloguj.php" method="GET">
						  ...
						  <form action="dodajoplate.php" method="GET">

											<button type="submit">Dodaj rachunek</button>
					  </form>
					  
							<form action="zatwierdzoplate.php" method="GET">

											<button type="submit">Zatwierdź rachunek</button>
					  </form>
